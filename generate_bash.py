...
with open("create_users_hourly.sh", "w") as cb:
    for f in sorted(Path("page/keys_hourly").iterdir()):
        ...
        if f.stem in ["2020-08-04-9", "2020-08-08-18", "2020-08-08-8", "2020-08-12-10", "2020-08-15-8", "2020-08-18-15", "2020-08-18-19", "2020-08-22-12", "2020-08-24-5", "2020-08-25-10", "2020-08-27-9"]:
